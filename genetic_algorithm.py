...
def sort_population(population: list[Solution], fitness: List[float]) -> Tuple[List[Solution], List[float]]:
    """
    ...
    sorted_combined_lists: list[tuple[Solution, float]] = sorted(combined_lists, key=lambda x: x[1])
